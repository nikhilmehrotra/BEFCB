...
function LimitText(TextValue, Length){
    return (TextValue.length > Length) ? TextValue.substr(0, Length)+'...' : TextValue.substr(0, Length)
}
...
function SaveLog(Do,WhatChanged,OldValue,NewValue){
    var parm = {}
    if(typeof Do !== undefined){
        parm.Do = String(Do);
    }
    if(typeof WhatChanged !== undefined){
        parm.WhatChanged = String(WhatChanged);
    }
    if(typeof OldValue !== undefined){
        parm.OldValue = String(OldValue);
    }
    if(typeof NewValue !== undefined){
        parm.NewValue = String(NewValue);
    }
    ajaxPost("/web-cb/acl/savelog",parm,function(){})
}
