;(function() {
  ...
  $(function() {
    ...
    // $(model.bootstrapSwitchSelector()).find("input[type=\"checkbox\"], input[type=\"radio\"]").not("[data-switch-no-init]").bootstrapSwitch();
    $(model.bootstrapSwitchSelector()).find("input[switch=\"on\"]").not("[data-switch-no-init]").bootstrapSwitch();
